    ...
    <Box height="100%" position="relative">
      ...
      <Box mb={3} px="20px">
        ...
        <Text fontSize="0.8rem">
          Lorem ipsum dolor sit amet, maximus blandit at vitae ex. Vestibulum
          mollis elementum nisl vel mattis. Sed efficitur nunc et sapien semper{" "}
      ...
      >
        <Box>
          <Text>Price</Text>
          <Text>
            <Text fontSize={"2rem"} as="span" color={colorPrimary.hex}>
              € 540
            </Text>{" "}
            /day
          </Text>
